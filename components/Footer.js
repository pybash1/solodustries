        ...
        <div class="max-w-3xl mx-auto space-y-6">
          <div class="flex justify-center space-x-6">
            ...
            <a
              ...
              href="https://github.com/pybash1/solodustries"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
            >
          ...
          <nav class="relative flex flex-wrap justify-center gap-8 p-8 text-sm font-bold border-4 border-white rounded-xl">
            <a
            ...
            <a
              class="hover:opacity-75"
              href="https://pybash.hashnode.dev"
              target="_blank"
              rel="noopener noreferrer"
            >
              Blog
          ...
          <p class="max-w-lg mx-auto text-xs text-gray-500">
            ...
            <a
              class="block mt-1 text-indigo-600 underline decoration-wavy decoration-indigo-500 hover:opacity-75"
              href="/"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <p class="text-xs font-medium">2022 Py Bash</p>
        </div>
      </div>
    </footer>
  );
